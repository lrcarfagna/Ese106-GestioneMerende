...
public class Ese106 {
	...
	public static void main(String[] args) throws Exception {
		...
		primo.addArticolo(new Bevanda("coca30cl", "Coca-Cola", 1.5, 40, 30));
		primo.addArticolo(new Bevanda("coca30cl", "Coca-Cola", 1.5, 40, 30));
		...
		try {
			...
			if(e.getMessage().equals("panino sia vegetariano che con carne suina"))
				System.out.println("OK");
			else
				System.out.println("ERRORE");
		}
		...
		try {
			...
			if(e.getMessage().equals("Articolo=null"))
				System.out.println("OK");
			else
				System.out.println("ERRORE");
		}
		...
		try {
			...
			if(e.getMessage().equals("ordine già presente"))
				System.out.println("OK");
			else
				System.out.println("ERRORE");
		}
